defmodule Tox.DateTimeTest do
  ...
  describe "add/3" do
    test "subtracts a year" do
      ...
      assert Tox.DateTime.add(datetime, year: -1) == expected
    end
    ...
    test "adds a month at new year" do
      ...
      assert Tox.DateTime.add(datetime, month: 1) == expected
    end
    ...
    test "subtracts 12 months or a year" do
      ...
      assert Tox.DateTime.add(datetime, year: -1) == expected
      assert Tox.DateTime.add(datetime, month: -12) == expected
    end
    ...
    test "subtracts 24 months or two years" do
      ...
      assert Tox.DateTime.add(datetime, year: -2) == expected
      assert Tox.DateTime.add(datetime, month: -24) == expected
    end
    ...
    test "adds a day" do
      ...
      assert Tox.DateTime.add(datetime, day: 1) == expected
    end
    ...
    test "adds a hour at the end of a year" do
      ...
      assert Tox.DateTime.add(datetime, hour: 1) == expected
    end
    ...
    test "adds two month and one hour" do
      ...
      assert Tox.DateTime.add(datetime, month: 2, hour: 1) == expected
    end
    ...
    test "add/subtracts time up to the previous/next day" do
      ...
      assert Tox.DateTime.add(later, hour: -15, minute: -10, second: -10) == earlier
      assert Tox.DateTime.add(earlier, hour: 15, minute: 10, second: 10) == later
    end
    ...
    test "add/subtracts time up to the later/earlier day" do
      ...
      assert Tox.DateTime.add(later, hour: -87, minute: -10, second: -10) == earlier
      assert Tox.DateTime.add(earlier, hour: 87, minute: 10, second: 10) == later
    end
    ...
    test "add/subtracts 24 hours" do
      ...
      assert Tox.DateTime.add(later, hour: -46, minute: -59, second: -60) == earlier
      assert Tox.DateTime.add(earlier, hour: 46, minute: 59, second: 60) == later
    end
    ...
    test "resulting in a gap with coptic calendar" do
      ...
      assert Tox.DateTime.add(datetime, microsecond: -142, day: -44, year: 159) ==
               %DateTime{
                 calendar: Cldr.Calendar.Coptic,
                 day: 19,
                 hour: 3,
    ...
    test "adds all durations" do
      ...
      assert Tox.DateTime.add(datetime, durations) == expected
    end
    ...
    test "adds no durations" do
      ...
      assert Tox.DateTime.add(datetime, []) == datetime
    end
    ...
    test "adds in falling direction" do
      ...
      assert datetime |> Tox.DateTime.add(day: 1, month: 1) == expected
      assert datetime |> Tox.DateTime.add(month: 1) |> Tox.DateTime.add(day: 1) == expected

      assert datetime |> Tox.DateTime.add(day: 1) |> Tox.DateTime.add(month: 1) ==
    ...
    test "raises an error" do
      ...
      assert_raise ArgumentError, ~r/cannot.add.*utc_only_time_zone_database/, fn ->
        Tox.DateTime.add(datetime, [hour: 1], @utc_only)
      end
    end
    ...
    test "subtract hours starting in an ambiguous period (earlier)" do
      ...
      assert Tox.DateTime.add(datetime, hour: -48) == expected
    end
  ...
  property "add/3" do
    check all datetime <- Generator.datetime(),
      ...
      assert valid_datetime?(Tox.DateTime.add(datetime, durations))
    end
  end
